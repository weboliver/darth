class XBOXControllerEvents:
    ...
    def init_events(self):
        ...
        self.add_event("BTN_Y", "BTN", 307, 1, 1, "")
        self.add_event("BTN_Y", "BTN", 307, 1, 0, "")
        self.add_event("BTN_X", "BTN", 306, 1, 1, "")
        self.add_event("BTN_X", "BTN", 306, 1, 0, "")
        self.add_event("BTN_RT", "BTN", 311, 1, 1, "stopcar")
        ...
        self.add_event("STOP", "BTN", 158, 1, 1, "")
